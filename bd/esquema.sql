...
-- -----------------------------------------------------
-- Data for table `equipe385116`.`RESERVA`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385116`;
INSERT INTO `equipe385116`.`RESERVA` (`ISBN`, `username`, `data_reserva`, `prazo_dev`) VALUES (145623, 'italobarros', '2018-10-10', '2018-10-25');
INSERT INTO `equipe385116`.`RESERVA` (`ISBN`, `username`, `data_reserva`, `prazo_dev`) VALUES (187456, 'renao', '2018-10-15', '2018-11-10');
INSERT INTO `equipe385116`.`RESERVA` (`ISBN`, `username`, `data_reserva`, `prazo_dev`) VALUES (187456, 'mumu', '2018-10-30', '2018-11-30');
INSERT INTO `equipe385116`.`RESERVA` (`ISBN`, `username`, `data_reserva`, `prazo_dev`) VALUES (175624, 'mumu', '2018-09-30', '2018-10-30');
INSERT INTO `equipe385116`.`RESERVA` (`ISBN`, `username`, `data_reserva`, `prazo_dev`) VALUES (159478, 'italobarros', '2018-10-06', '2018-10-21');
INSERT INTO `equipe385116`.`RESERVA` (`ISBN`, `username`, `data_reserva`, `prazo_dev`) VALUES (175624, 'italobarros', '2018-10-31', '2018-11-15');
