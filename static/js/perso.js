$("#tipo_drop_add").change(function(){
	if($("#tipo_drop_add").val() == "tipoProf"){
		...
		$data_form = '<div class="row"> <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> <div class="form-element-list mg-t-30"> <div class="row"> <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> <div class="form-group ic-cmp-int form-elet-mg res-mg-fcs"> <div class="form-ic-cmp"> <i class="notika-icon notika-edit"></i> </div><div class="nk-int-st"> <input type="text" name="matricula" class="form-control" placeholder="Matrícula SIAPE"> </div></div></div><div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"> <div class="form-group ic-cmp-int"> <div class="form-ic-cmp"> <i class="notika-icon notika-calendar"></i> </div><div class="nk-int-st"> <input type="text" name="data_de_contratacao" class="form-control date" data-mask="99/99/9999" placeholder="Ano de contrato (yyyy/mm/dd)"> </div></div></div><div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> <div class="form-group ic-cmp-int"> <div class="form-ic-cmp"> <i class="notika-icon notika-phone"></i> </div><div class="nk-int-st"> <input type="text" name="telefone_celular" class="form-control" data-mask="(999) 999-9999" placeholder="Telefone (apenas números com ddd)"> </div></div></div></div> <div class="row"> <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:10px;"> <h5 style="display: inline-block;margin-right: 10px;">Selecione um curso: </h5> <div class="btn-group btn-group-toggle" data-toggle="buttons"> <label class="btn btn-secondary active"> <input type="radio" name="cod_curso_prof" value="2" id="option1" autocomplete="off" checked> Engenharia </label> <label class="btn btn-secondary"> <input type="radio" name="cod_curso_prof" value="1"  autocomplete="off"> Medicina </label> <label class="btn btn-secondary"> <input type="radio" name="cod_curso_prof" value="3" id="option3" autocomplete="off"> Economia </label> </div></div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:10px;"> <h5 style="display: inline-block;margin-right: 10px;">Selecione a carga horária: </h5> <div class="btn-group btn-group-toggle" data-toggle="buttons"> <label class="btn btn-secondary active"> <input type="radio" name="regime_trabalho" value="20h" id="option1" autocomplete="off" checked> 20h </label> <label class="btn btn-secondary"> <input type="radio" name="regime_trabalho" value="40h" id="option2" autocomplete="off"> 40h </label> </div></div></div></div></div></div>';
